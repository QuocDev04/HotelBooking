...
const RoomDetail = () => {
    ...
    object-cover cursor-pointer ${mainImage === image ? 'border-4 border-orange-500' : ''}`}
                        />
                    ))}
                </div>
            </div>
            ...
            shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <button type='submit' className='bg-blue-700 hover:bg-blue-900 accent-slate-100 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-24 py-3 md:py-4 text-base cursor-pointer'>
                    Check Availability
                </button>
            </form>
