        ...
        <div className='py-28 md:pb-36 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {bookings.map((bookings) => (
                    <div key={bookings._id} className='grid gird-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        {/* Hotel DetailsDetails */}
                        <div className='flex flex-col md:flex-row'>
                            <img src={bookings.room.images[0]} alt="" className='w-44 rounded shadow object-cover' />
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            <div className='flex items-center gap-2'>
                                ...
                                <p className={`text-sm rounded-full ${bookings.isPaid ? "text-green-500" : "text-red-500"} `}>
